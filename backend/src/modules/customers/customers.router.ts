...
import { listHandler, getHandler, deleteHandler, listMessagesHandler, sendMessageHandler, listActivityHandler, listReferralsHandler } from './customers.controller.js';
...
customersRouter.get('/:id/referrals', listReferralsHandler);
